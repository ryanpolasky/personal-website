        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{
              ...
              r.style.setProperty('--color-accent',a.b);r.style.setProperty('--color-accent-warm',a.w);r.style.setProperty('--color-accent-soft',a.s);r.setAttribute('data-accent',a.n);
